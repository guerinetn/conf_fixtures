...
=== image:images/logos/doctrine.svg[doctrine,120] FixtureBundle
...
image::images/fixtures/carte-france-regions-departements.webp[carte,450px]
...
=== image:images/logos/doctrine.svg[doctrine,120] DependentFixtureInterface
...
[.fade-out, step=1]
====
image::images/fixtures/tons-of-file.jpg[tons,400px]
[.credit]
...
<div style="display:flex; gap:2em; justify-content:center; align-items:center;">
  <div style="display:flex; flex-direction:column; gap:1em; align-items:center;">
    <img src="images/fixtures/pdf.png" width="200">
    <img src="images/fixtures/fichier_bash.png">
  </div>
  <img src="images/fixtures/fichier_test.png" width="300">
</div>
+++
...
--
[.fade-out, step=1]
image::images/fixtures/workflow_complet.svg[workflow,30%]
...
=== image:images/logos/doctrine.svg[doctrine,120] Le registre
...
[step=2]
image::images/fixtures/depose_diagram.svg[depose]
--
...
image::images/fixtures/workflow_start_complete.svg[workflow,100%]
...
image::images/fixtures/roadrunner.png[bibibp,60%]
...
image::images/fixtures/workflow_rejet.png[rejet,100%]
