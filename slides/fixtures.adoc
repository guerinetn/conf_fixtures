...
[step=1]
[source, php,%linenums,highlight="1..9|11..16"]
----
...
$instructeur= $this->getReference('INSTRUCTEUR_' . $dpt->getCode(), $instructeur);

$superviseur = $this->getReference('SUPERVISEUR_' . $region->getCode(), $superviseur);
